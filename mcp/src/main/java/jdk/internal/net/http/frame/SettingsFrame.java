...
public class SettingsFrame extends Http2Frame {
    ...
    public String flagAsString(int flag) {
        String flagStr;
        switch (flag) {
            case ACK : flagStr="ACK";break;
            default : flagStr=super.flagAsString(flag);
        }
        return flagStr;
    }
    ...
    private String name(int i) {
        String name;
        switch (i + 1) {
            case HEADER_TABLE_SIZE      :name= "HEADER_TABLE_SIZE";break;
            case ENABLE_PUSH            :name= "ENABLE_PUSH";break;
            case MAX_CONCURRENT_STREAMS :name= "MAX_CONCURRENT_STREAMS";break;
            case INITIAL_WINDOW_SIZE    :name= "INITIAL_WINDOW_SIZE";break;
            case MAX_FRAME_SIZE         :name= "MAX_FRAME_SIZE";break;
            case MAX_HEADER_LIST_SIZE   :name= "MAX_HEADER_LIST_SIZE";break;

            default :name= "unknown parameter";
        }
        return name;
    }
