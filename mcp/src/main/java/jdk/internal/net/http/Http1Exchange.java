...
class Http1Exchange<T> extends ExchangeImpl<T> {
    ...
    static abstract class Http1BodySubscriber implements Flow.Subscriber<ByteBuffer> {
        ...
        static final List<ByteBuffer> COMPLETED = Collections.singletonList(ByteBuffer.allocate(0));
    ...
    CompletableFuture<ExchangeImpl<T>> sendBodyAsync() {
        ...
        return Utils.wrapForDebug(null, "sendBodyAsync", bodySentCF);
    }
    ...
    CompletableFuture<Response> getResponseAsync(Executor executor) {
        ...
        return Utils.wrapForDebug(null, "getResponseAsync", cf);
    }
