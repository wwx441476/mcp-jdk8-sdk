...
public class SSLFlowDelegate {
    ...
    final java.util.Logger debug =
            java.util.Logger.getLogger(getClass());
    ...
    */
    ...
    private void setALPN() {
        ...
        if (alpnCF.isDone())
            return;
        String alpn = engine.getEnabledProtocols()[0];
    ...
    final class Reader extends SubscriberWrapper implements FlowTube.TubeSubscriber {
        ...
        final java.util.Logger debugr = java.util.Logger.getLogger(getClass());
    ...
    class Writer extends SubscriberWrapper {
        ...
        final Logger debugw =  Logger.getLogger(getClass());
        volatile boolean completing;
