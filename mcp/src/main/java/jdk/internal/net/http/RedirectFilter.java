...
class RedirectFilter implements HeaderFilter {
    ...
    private static String redirectedMethod(int statusCode, String orig) {
        String method;
        switch (statusCode) {
            case 301 : method=orig.equals("POST") ? "GET" : orig;break;
            case 302 : method=orig.equals("POST") ? "GET" : orig;break;
            case 303 : method="GET";break;
            case 307 : method=orig;break;
            case 308 : method=orig;break;

            default : method=orig; // unexpected but return orig
        }
        return method;
    }
    ...
    private static boolean isRedirecting(int statusCode) {
        ...
        switch (statusCode) {
            ...
            case 300: isRedirecting = false;break;
            case 304 : isRedirecting=false;break;
            case 305 : isRedirecting=false;break;
            case 306 : isRedirecting=false;break;
            // 301, 302, 303, 307, 308: OK to follow.
            default : isRedirecting = true;
        };
    ...
    private boolean canRedirect(URI redir) {
        ...
        switch (policy) {
            ...
            case NEVER:
                ...
                break;
            case NORMAL:
                canRedirect = newScheme.equalsIgnoreCase(oldScheme)
