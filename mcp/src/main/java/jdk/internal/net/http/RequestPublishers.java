...
public final class RequestPublishers {
    ...
    public static class ByteArrayPublisher implements BodyPublisher {
        ...
        public void subscribe(Flow.Subscriber<? super ByteBuffer> subscriber) {
            ...
            PullPublisher delegate = new PullPublisher<>(copy);
    ...
    public static class IterablePublisher implements BodyPublisher {
        ...
        public void subscribe(Flow.Subscriber<? super ByteBuffer> subscriber) {
            ...
            PullPublisher delegate = new PullPublisher<>(iterable);
            delegate.subscribe(subscriber);
        }
            ...
            try {
                ...
                try {
                    ...
                    if (ioe instanceof FileNotFoundException) {
                        ...
                        FileNotFoundException ex = new FileNotFoundException(ioe.getMessage());
                        ex.initCause(ioe);
                        throw ex;
                    }
                }
...
//        }
    ...
    public static BodyPublisher concat(BodyPublisher... publishers) {
        if (publishers.length == 0) {
            ...
            return new AggregatePublisher(Arrays.asList(publishers));
        }
    }
