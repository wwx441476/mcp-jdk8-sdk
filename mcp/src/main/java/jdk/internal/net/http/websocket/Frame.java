...
final class Frame {
    ...
    static final class Masker {
        ...
        Masker mask(int value) {
            acc.clear();
            acc.putInt(value).putInt(value).flip();
            ...
            while (true) {
                ...
                switch (state) {
                    ...
                    case READING_16_LENGTH:
                        ...
                        accumulator.flip();
                        remainingPayloadLength = accumulator.getChar();
                    ...
                    case READING_64_LENGTH:
                        ...
                        accumulator.flip();
                        remainingPayloadLength = accumulator.getLong();
                    ...
                    case READING_MASK:
                        ...
                        accumulator.flip();
                        consumer.maskingKey(accumulator.getInt());
                        accumulator.clear();
