 ...
 * HttpClient} is created through a {@link Builder builder}.
...
public abstract class HttpClient {
    ...
    public interface Builder {
         ...
         *
         * @apiNote {@link ProxySelector#(InetSocketAddress) ProxySelector::of}
         ...
         * one returned by {@link ProxySelector#(InetSocketAddress)
     ...
     * {@code CompletableFuture} objects {@linkplain CompletableFuture#()
